...
class QuotationController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('quotations.create', compact('dtobj','op_name','disc_res','cfg_res','request','maxshipvol','quote_type','sheet_type','shipment_type','cargo_type','currency_type','showtable','inr_usd','aed_usd'));
    }
    ...
    public function show(string $id) //string $id
    {
		...
		$showtable = true;
		$quote_type = $sheet_type = $shipment_type = $cargo_type = $currency_type = '';
		if($quoteentry)
		{
        ...
        return view('quotations.show', compact('quoteentry','materialDetails','dtobj','disc_res','cfg_res','maxshipvol','quote_type','sheet_type','shipment_type','cargo_type','cargoarr','currency_type','showtable','inr_usd','aed_usd','disc_arr'));
