...
class QuotationController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('quotations.create', compact('dtobj','op_name','disc_res','cfg_res','request','maxshipvol','quote_type','sheet_type','shipment_type','cargo_type','currency_type','cons_act_weight','showtable','inr_usd','aed_usd','sheet_type_arr','exrate_updated','createpagehidden','cst_fwd_distr_buyer'));
    }
	...
	public function updatecostfwddistbuyer(Request $request)
	{
		$cst_fwd_distr_buyer = isset($request->cst_fwd_distr_buyer) ? $request->cst_fwd_distr_buyer : 0;
			...
			{
				DB::table('config_fields')->where('is_delete',0)->where('para_name','cst_fwd_distr_buyer')->update($data_arr1);
			}
