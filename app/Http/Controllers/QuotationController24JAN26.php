...
class QuotationController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('quotations.create', compact('dtobj','op_name','disc_res','cfg_res','request','maxshipvol','quote_type','sheet_type','shipment_type','cargo_type','currency_type','showtable','inr_usd','aed_usd','sheet_type_arr','exrate_updated'));
    }
