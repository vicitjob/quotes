...
Route::post('getfpproductsname', [App\Http\Controllers\QuotationController::class, 'getfpproductsname']);
Route::post('getprddata', [App\Http\Controllers\QuotationController::class, 'getprddata']);
Route::get('updateexchangerate', [App\Http\Controllers\QuotationController::class, 'updateexchangerate']);
Route::get('updatecostfwddistbuyer', [App\Http\Controllers\QuotationController::class, 'updatecostfwddistbuyer']);
Route::get('setupparams', [App\Http\Controllers\QuotationController::class, 'setupparams']);
