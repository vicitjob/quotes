...
<table style="width:100%;" class="headertbl">
	<tr>
		...
		<td style="width:35%;">
			<h2 style="text-align:center;text-decoration: underline;">GATE ENTRY CONFIRMATION RECEIVING DEPARTMENT</h2>
		</td>
		<td style="width:30%;">
...
<table class="orderdetail " style="width:100%;border: 1px solid black;">
	...
	<thead>
		<tr>
			...
			<th width="7%">No. of Container</th>
			<th width="15%">Remark</th>
			<th width="4%">Store Qty</th>
	...
	<tbody>
		...
		if($containerDetails->count() > 0)
		{
			foreach($containerDetails as $contobj)
			{
				...
				echo '<td class="onright">'.$contobj->cont_storeqty.'</td>';
				echo '<td>'.$contobj->cont_storeremark.'</td>';
				echo '</tr>';
			}
		}
		else
...
<table class="orderdetail" style="width:100%;border: 1px solid black;">
	...
	<tbody>
		...
		{
			echo '<tr><td colspan="9">No Item Found.</td></tr>';
		}
		?>
	</tbody>
...
<table style="width:100%;">
	<tr>
		<td colspan="3" class="txtlbl entryfootcol1">______________________________________________ </td>
		<td colspan="3" class="txtlbl entryfootcol2">&nbsp;</td>
	</tr>
     <tr>
		<td class="txtlblfoot entryfootcol1">Dept. InCharge:</td>
        <td colspan="2" class="entryfootcol2"><?php echo $dept_incharge; ?></td>
		
        <td class="txtlbl entrycol1">Dept. Conf. Date:</td>
        <td colspan="2" class="entrycol2"><?php echo ($gateentry) ? (($gateentry->dept_dt) ? date('d-m-Y H:i', strtotime($gateentry->dept_dt)) : '') : '-'; ?></td>
	...
	<tr>
		...
		<td class="txtlbl entrycol1">Gate-In Supervisor: </td>
		<td class="entrycol2"><?php echo ($gateentry) ? $gateentry->createdby_name : ''; ?></td>
	...
	<tr>
		...
		<td class="txtlbl entrycol1">Gate-Out Supervisor: </td>
		<td class="entrycol2"><?php echo ($closed_by) ? $closed_by : '-'; ?></td>
	...
	<tr class="tbltopspace2">
		<td colspan="6" ><span class="txtlbl">Gate Check-In Security Remark: </span><span class="entrycol2"><?php echo ($gateentry) ? $gateentry->remarks : ''; ?></span></td>
        		
    </tr>
	<tr class="tbltopspace2">
		<td colspan="6" ><span class="txtlbl">Gate Check-Out Security Remark: </span><span class="entrycol2"><?php echo ($gateentry) ? $gateentry->checkout_remark : ''; ?></span></td>
