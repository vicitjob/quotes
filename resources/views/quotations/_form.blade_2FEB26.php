			...
			<table class="table table-bordered" id="tblcontaineritem" style="width:100%;margin-bottom:0px;">
				<thead>
					...
					<tr class="headcols">
						...
						<th class="oncent coltotalprice"><span class="currtype"><?php echo $currency_type;?></th>
						<th class="oncent colforcust">INR</th>
				...
				?>
					<tr id="controw<?php echo $rowk2;?>">
						...
						<td class="colforcust">
							...
							<input class="form-control onlydecimalval onright tblinput" type="text" name="forwardingcostinr[]" id="forwardingcostinr<?php echo $rowk2;?>" value="<?php echo ($quoteentry) ? ((isset($materialDetails[$k2]) ? $materialDetails[$k2]->forwardingcostinr : 0)) : 0;?>" <?php echo $fieldattr;?> onchange="updatefwdcost(<?php echo $rowk2;?>);" />
