...
<div class="row" >
			...
			<table class="table table-bordered" id="tblcontaineritem" style="width:100%;margin-bottom:0px;">
				<thead>
					<tr class="headcols">
						...
						<th class="oncent" colspan="2" style="width:12%;">Discount To Distributor</th>
						...
						<th class="oncent coltotalprice" style="width:5%;">Total Price</th>
						<!--th class="oncent colforcust" style="width:5%;">Fwd Cost</th-->
						<th class="oncent colforcust" style="width:5%;">Distr. Margin</th>
						<th class="oncent colforcust" style="width:5%;">Dealer's Cost</th>
						<th class="oncent colforcust" style="width:6%;">Dealer Total Cost</th>
						<th class="oncent recomdistsptobuyer colforcust" style="width:5%;">Quoted.Distr. S.P. to Buyer</th>
						<th class="oncent colforcust" style="width:5%;">Quoted SP after Credit & MiniMan</th>
						<th class="oncent colforcust" style="width:6%;">Total Quoted</th>
					</tr>
					<tr class="headcols">
						<th>&nbsp;</th>
						<th>&nbsp;</th>
						...
						<th class="oncent coltotalprice"><span class="currtype"><?php echo $currency_type;?></span></th>
						
						<!--th class="oncent colforcust"><span class="currtype"><?php //echo $currency_type;?></span></th-->

						<th class="oncent colforcust">In %</th>
						<th class="oncent colforcust"><span class="currtype"><?php echo $currency_type;?></span></th>
						<th class="oncent colforcust"><span class="currtype"><?php echo $currency_type;?></span></th>
						<th class="oncent recomdistsptobuyer colforcust"><span class="currtype"><?php echo $currency_type;?></span></th>
				...
				?>
					<tr id="controw<?php echo $rowk2;?>">
						...
						<td class="backyellow">
							...
							<select style="width:100%;pointer-events: none;" class="backyellow" name="disc_type[]" id="disc_type<?php echo $rowk2;?>" onchange="setdisvalue(this.value,<?php echo $rowk2;?>);" <?php echo $fielddisabl;?>>
								...
								if($disc_res->count() > 0)
								{
									foreach($disc_res as $discobj)
									{
										...
										if($discobj->dealerid != $tmpdealerid)
										{
											$tmpdealerid = $discobj->dealerid;
											$tmplbl = 'Customer';
											$tmpdiscid = 'customeropt';
											if($discobj->dealerid == 1)
											{
												$tmplbl = 'Dealer1';
												$tmpdiscid = 'dealer1opt';
											}
											else if($discobj->dealerid == 2)
											{
												$tmplbl = 'Dealer2';
												$tmpdiscid = 'dealer2opt';
											}
											echo '<optgroup label="'.$tmplbl.'" id="'.$tmpdiscid.'">';
										}
						...
						<td>
							<input class="form-control onlydecimalval onright tblinput" type="text" name="disc_val[]" id="disc_val<?php echo $rowk2;?>" value="<?php echo ($quoteentry) ? ((isset($materialDetails[$k2]) ? $materialDetails[$k2]->disc_val : '')) : '';?>" onchange="setshiptoqty(<?php echo $rowk2;?>);"  <?php echo ($quoteentry) ? 'READONLY' : 'READONLY';?> />
						</td>
						...
						<td class="backdarkgreen colexworks colexworksusd">
						...
						<td class="ttlcostfont coltotalprice">
							
							<span class="floatonright tblinput backdarkyellow currencyspan colexworksttlpspan" id="colexworksttlp_span<?php echo $rowk2;?>"><?php echo ($quoteentry) ? ((isset($materialDetails[$k2]) ? $materialDetails[$k2]->coltotalprice : '')) : '';?></span>
							
							<input class="currencyinp colexworksttlp" type="hidden" name="coltotalprice[]" id="coltotalprice<?php echo $rowk2;?>" value="<?php echo ($quoteentry) ? ((isset($materialDetails[$k2]) ? $materialDetails[$k2]->coltotalprice : '')) : '';?>" READONLY />
							
							
						</td>
						<!--td class="colforcust">
							
							<input class="form-control onlydecimalval onright tblinput currencyinp" type="text" name="forwardingcostinr[]" id="forwardingcostinr<?php //echo $rowk2;?>" value="<?php //echo ($quoteentry) ? ((isset($materialDetails[$k2]) ? $materialDetails[$k2]->forwardingcostinr : 0)) : 0;?>" <?php //echo $fieldattr;?> onchange="updatefwdcost(<?php //echo $rowk2;?>);" READONLY />
							<input type="hidden" id="forwardingcostinrhid<?php //echo $rowk2;?>" value="0" />
						</td-->
						
						<td class="colforcust">
							
							<input class="form-control onlydecimalval onright tblinput" type="text" name="distr_margin[]" id="distr_margin<?php echo $rowk2;?>" value="<?php echo ($quoteentry) ? ((isset($materialDetails[$k2]) ? $materialDetails[$k2]->distr_margin : 0)) : '';?>" <?php echo $fieldattr;?> onchange="updatefwdcost(<?php echo $rowk2;?>);" READONLY />
						...
						<td class="ttlcostfont colforcust">
						...
						<td class="recomdistsptobuyer colforcust">
				...
				<?php
					...
					<tr class="totalcols">
						...
						<td class="ttlcostfont coltotalprice">
							<span class="floatonright tblinput backdarkyellow currencyspan" id="colgtotalprice_span"><?php echo ($quoteentry) ? $quoteentry->colgtotalprice : 0;?></span>
							
							<input class="currencyinp" type="hidden" name="colgtotalprice" id="colgtotalprice" value="<?php echo ($quoteentry) ? $quoteentry->colgtotalprice : 0;?>" READONLY />
						</td>
						...
						<td class="colforcust" style="font-weight:600;background-color:#eee;">
							Total:
							
						</td>
						
						<td class="ttlcostfont colforcust" style="background-color:#eee;">
					...
					<tr>
						<td class="savebtns" colspan="35" style="text-align:center;">
		...
		<div class="col-md-2 whitebox">
			<div class="adarea">
				...
				<div class="adtextarea" id="paraccordion">
					<div class="tplhead2 clearfix MB5">
						<h6 class="stkhead2 dispflex">Parameters Used</h6>
					</div>
					<div class="col-md-12 rightpanelarea custom-accordion-content">
						<?php
							if($cfg_res->count() > 0)
							{
								...
								foreach($cfg_res as $res)
								{
									...
									{
										echo '<span style="font-weight:bold;">'.$res->para_lbl.':</span><span style="font-style:italic;" id="p_'.$res->para_name.'"> '.(($res->para_value) ? number_format($res->para_value, 2) : "").'</span><br>';
									}
								}
				...
				<div class="adtextarea">
					...
					<div class="col-md-12 rightpanelarea dispflex">
						<label class="col-md-5 lblcommon">INR / USD : 
						</label>
						&#8377;&nbsp; 

						<input style="width:35%;" class="form-control onlydecimalval onright tblinput" onchange="updateexrate();" type="text" name="exchange_inr_usd" id="exchange_inr_usd" value="<?php echo ($quoteentry) ? $quoteentry->inr_usd_ex : $inr_usd;?>" <?php echo ($quoteentry) ? 'READONLY' : 'READONLY';?>>
				...
				<div class="adtextarea">
					<div class="tplhead2 clearfix MB5">
						<h6 class="stkhead2">Fwd Cost from Distr to Buyer</h6>
					</div>
					
					<div class="col-md-12 rightpanelarea dispflex">
						<label class="col-md-5 lblcommon">AED : 
						</label>
						<input style="width:35%;" class="form-control onlydecimalval onright tblinput " onchange="updatecostfwddistbuyer();" type="text" name="cst_fwd_distr_buyer" id="cst_fwd_distr_buyer" value="<?php echo ($quoteentry) ? $quoteentry->cst_fwd_distr_buyer : $cst_fwd_distr_buyer;?>" <?php echo ($quoteentry) ? 'READONLY' : 'READONLY';?>>
