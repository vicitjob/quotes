...
<div class="row" >
			...
			<table class="table table-bordered" id="tblcontaineritem" style="width:100%;">
				<thead>
					<tr class="headcols">
						...
						<th class="oncent" style="width:5%;">Dealer Total Cost</th>
						<th class="oncent" style="width:6%;">Total Cost</th>
						<th class="oncent recomdistsptobuyer" style="width:5%;">Recom.Distr. S.P. to Buyer</th>
						<th class="oncent" style="width:5%;">Recom SP after Credit & MiniMan</th>
						<th class="oncent" style="width:6%;">Total Cost</th>
					</tr>
					<tr class="headcols">
						<th>&nbsp;</th>
		...
		<div class="col-md-2">
			<h6 style="text-decoration:underline;"><?php echo ($quoteentry) ? '' : 'Current ';?>Exchange Rate</h6>
			<label class="col-md-12 lblcommon" style="font-weight:600;">INR/USD: <span id="exchange_inr_usd"><?php echo ($quoteentry) ? $quoteentry->inr_usd_ex : $inr_usd;?></span></label><br/>
			<label class="col-md-12 lblcommon" style="font-weight:600;">AED/USD: <span id="exchange_inr_aed"><?php echo ($quoteentry) ? $quoteentry->aed_usd_ex : $aed_usd;?></span></label>
		</div>
