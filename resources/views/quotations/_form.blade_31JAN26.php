				...
				?>
					<tr id="controw<?php echo $rowk2;?>">
						...
						<td class="colforcust">
							...
							<input class="form-control onlydecimalval onright tblinput" type="text" name="forwardingcostinr[]" id="forwardingcostinr<?php echo $rowk2;?>" value="<?php echo ($quoteentry) ? ((isset($materialDetails[$k2]) ? $materialDetails[$k2]->forwardingcostinr : 0)) : 0;?>" onchange="updatefwdcost(<?php echo $rowk2;?>);" />
