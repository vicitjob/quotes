			...
			<table class="table table-bordered" id="tblcontaineritem" style="width:100%;margin-bottom:0px;">
				<thead>
					<tr class="headcols">
						...
						<th class="oncent colforcust" style="width:5%;">Forwarding Cost</th>
			...
			<div class="adarea">
				<div class="adtextarea">
					...
					<div class="col-md-12 rightpanelarea dispflex">
						...
						&#8377;&nbsp; 
						<input style="width:35%;" class="form-control onlydecimalval onright tblinput" onchange="updateexrate();" type="text" name="exchange_inr_usd" id="exchange_inr_usd" value="<?php echo ($quoteentry) ? $quoteentry->inr_usd_ex : $inr_usd;?>">
				...
				<div class="adtextarea">
					<div class="tplhead2 clearfix MB5">
						<h6 class="stkhead2" style="font-size:0.9rem;">Cst of Forwd from Distr to Buyer</h6>
					</div>
					
					<div class="col-md-12 rightpanelarea dispflex">
						<label class="col-md-5 lblcommon">AED : 
						</label>
						<input style="width:35%;" class="form-control onlydecimalval onright tblinput " onchange="updatecostfwddistbuyer();" type="text" name="cst_fwd_distr_buyer" id="cst_fwd_distr_buyer" value="<?php echo ($quoteentry) ? $quoteentry->cst_fwd_distr_buyer : $cst_fwd_distr_buyer;?>">
						<!--span class="col-md-7 lblcommon" id="exchange_inr_usd"><?php //echo ($quoteentry) ? $quoteentry->inr_usd_ex : $inr_usd;?></span-->
					</div>
