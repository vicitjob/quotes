				...
				?>
					<tr id="controw<?php echo $rowk2;?>">
						...
						<td class="colforcust">
							...
							<input class="form-control onlydecimalval onright tblinput currencyinp" type="text" name="distr_margin[]" id="distr_margin<?php echo $rowk2;?>" value="<?php echo ($quoteentry) ? ((isset($materialDetails[$k2]) ? $materialDetails[$k2]->distr_margin : 0)) : 0;?>" <?php echo $fieldattr;?> onchange="updatefwdcost(<?php echo $rowk2;?>);" READONLY />
			...
			<div class="adarea">
				...
				<div class="adtextarea">
					<div class="tplhead2 clearfix MB5">
						<h6 class="stkhead2">Parameters Used</h6>
					</div>
				...
				<div class="adtextarea">
					...
					<div class="col-md-12 rightpanelarea dispflex">
						...
						<input style="width:35%;" class="form-control onlydecimalval onright tblinput" onchange="updateexrate();" type="text" name="exchange_inr_usd" id="exchange_inr_usd" value="<?php echo ($quoteentry) ? $quoteentry->inr_usd_ex : $inr_usd;?>" <?php echo ($quoteentry) ? 'READONLY' : '';?>>
				...
				<div class="adtextarea">
					...
					<div class="col-md-12 rightpanelarea dispflex">
						...
						<input style="width:35%;" class="form-control onlydecimalval onright tblinput " onchange="updatecostfwddistbuyer();" type="text" name="cst_fwd_distr_buyer" id="cst_fwd_distr_buyer" value="<?php echo ($quoteentry) ? $quoteentry->cst_fwd_distr_buyer : $cst_fwd_distr_buyer;?>" <?php echo ($quoteentry) ? 'READONLY' : '';?>>
