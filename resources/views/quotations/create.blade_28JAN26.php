	...
	<form action="{{ route('quotations.create') }}" method="GET">
		<div class="row" style="margin-top:10px;">
			...
			<div class="col-md-2 dispflex">
				...
				<select style="width:100%;" name="sheet_type" id="sheet_type" onchange="submitfrm2();">
			...
			<div class="col-md-2 dispflex">
				...
				<select style="width:100%;" name="shipment_type" id="shipment_type" onchange="submitfrm2();">
